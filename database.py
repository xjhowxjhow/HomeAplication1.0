    ...
    def testedb(self):
        while True:
            ...
            if(os.path.exists(''+a+'/bando_de_valores.db')):
                ...
                cursor.execute("CREATE TABLE IF NOT EXISTS pagamentos_saldo(id_lancamento int,id_bank int,tipo_e_s text,valor text,data_pagamento text,saldo_atual text)")
